...
cl /std:c++20 /EHsc /Zm400 /DUSE_IMGUI=1 /Fo"%OUT%\obj\\" /Fe:"%OUT%\chronos.exe" /I"%SRC%" /I"%IMGUI%" /I"%WD%" ^
    "%SRC%\main.cpp" ^
    ...
    "%SRC%\nade\nade_engine.cpp" ^
    "%SRC%\aimbot\ragebot.cpp" "%SRC%\aimbot\resolver.cpp" "%SRC%\aimbot\autowall.cpp" "%SRC%\aimbot\quantum_aim.cpp" "%SRC%\aimbot\aim_controller.cpp" ^
    ...
    d3d11.lib dxgi.lib winmm.lib ws2_32.lib winhttp.lib
